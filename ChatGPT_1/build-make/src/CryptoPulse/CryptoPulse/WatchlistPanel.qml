        ...
        RowLayout {
            ...
            TextField {
                ...
                background: Rectangle {
                    radius: 11
                    color: symbolField.activeFocus ? Palette.panelHover : Palette.panel
                    border.color: symbolField.activeFocus ? Palette.accent : Palette.border
            ...
            Button {
                ...
                background: Rectangle {
                    radius: 11
                    color: parent.down ? Palette.accentBright
                                       : parent.hovered ? Qt.lighter(Palette.accent, 1.08)
                                                        : Palette.accent
