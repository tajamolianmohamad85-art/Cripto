    ...
    ColumnLayout {
        ...
        GraphsView {
            ...
            theme: GraphsTheme {
                ...
                seriesColors: [Theme.accentBright]
                borderColors: [Theme.accentBright]
                grid.mainColor: Qt.alpha(Theme.borderStrong, 0.34)
                grid.subColor: Qt.alpha(Theme.border, 0.14)
                axisX.mainColor: "transparent"
                axisY.mainColor: Qt.alpha(Theme.borderStrong, 0.6)
            }
            ...
            axisY: ValueAxis {
                ...
                labelDecimals: max < 0.01 ? 6 : max < 1 ? 4 : 2
                subTickCount: 1
            }
        ...
        Column {
            ...
            Button {
                ...
                background: Rectangle {
                    radius: 9
                    color: retryButton.hovered ? Theme.accentBright : Theme.accent
                }
            }
        }
    }
