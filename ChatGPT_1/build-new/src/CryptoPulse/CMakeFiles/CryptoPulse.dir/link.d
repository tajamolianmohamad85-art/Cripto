../../bin/CryptoPulse: \
  ...
  /usr/lib/libQt6Graphs.so.6.11.1 \
  /usr/lib/libQt6QuickControls2.so.6.11.1 \
  /usr/lib/libQt6Quick3D.so.6.11.1 \
  /usr/lib/libQt6Quick3DRuntimeRender.so.6.11.1 \
  /usr/lib/libQt6Quick3DUtils.so.6.11.1 \
  /usr/lib/libQt6ShaderTools.so.6.11.1 \
  ...
  /usr/lib/libQt6QuickShapes.so.6 \
